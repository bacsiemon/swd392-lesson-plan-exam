...
public partial class LessonPlanExamDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Class>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByTeacherNavigation).WithMany(p => p.Classes)
                .HasForeignKey(d => d.CreatedByTeacher)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("classes_created_by_teacher_fkey");
        });
        ...
        modelBuilder.Entity<ClassEnrollment>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.StudentId, e.ClassId }, "class_enrollments_student_id_class_id_key").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("class_slots_pkey");

            entity.ToTable("class_slots");
            ...
            entity.HasOne(d => d.Class).WithMany(p => p.ClassSlots)
                .HasForeignKey(d => d.ClassId)
                .HasConstraintName("class_slots_class_id_fkey");
        });
        ...
        modelBuilder.Entity<Exam>(entity =>
        {
            ...
            entity.HasOne(d => d.Class).WithMany(p => p.Exams)
                .HasForeignKey(d => d.ClassId)
                .HasConstraintName("exams_class_id_fkey");
        ...
        modelBuilder.Entity<LessonPlan>(entity =>
        {
            ...
            entity.Property(e => e.StatusEnum)
                .HasDefaultValue(EApprovalStatus.Requested)
                .HasColumnName("status_enum")
                .HasConversion<int>();
            entity.Property(e => e.Title)
                .IsRequired()
            ...
            entity.HasOne(d => d.ApprovedByNavigation).WithMany(p => p.LessonPlans)
                .HasForeignKey(d => d.ApprovedBy)
                .HasConstraintName("lesson_plans_approved_by_fkey");
